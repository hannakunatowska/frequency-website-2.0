...
line_ticks_custom = {
    0: [0, 0.009, 0.14, 0.6, 3.1],     # ticks for line 0
    1: [3.1, 4.65, 5, 5.68, 6.1],            # ticks for line 1
    2: [6.1, 7, 8.1, 9.2],            # ticks for line 2
    3: [9.2, 10.1, 11.4, 12.2]          # ticks for line 3
}
...
# --- Tkinter setup ---
root = tk.Tk()
root.title("Swedish Frequencies 0-12.2 MHz")
