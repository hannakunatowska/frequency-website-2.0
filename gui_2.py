...
line_ranges = {
    0: {"min": 0, "max": 12500},
    1: {"min": 12500, "max": 25000},
    2: {"min": 25000, "max": 37500},
    3: {"min": 37500, "max": 50000},
}
...
for b in raw:
    ...
    # Only include bands that intersect 0–50 000 MHz
    if end > start and end >= 0 and start <= 50000:
        # Clip to the 0–50 000 range
        start = max(start, 0)
        end = min(end, 50000)
...
# --- Tkinter setup ---
root = tk.Tk()
root.title("Frequency Allocation 0-50 000 MHz")
